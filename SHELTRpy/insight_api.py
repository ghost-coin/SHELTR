...
class Api:
    ...
    async def getBlock(self, blockHash):
        response = await request(
            f"{self.BASE_URL}/api/block/{blockHash}/",
            method="GET",
    ...
    async def getBlockHash(self, blockIndex):
        response = await request(
            f"{self.BASE_URL}/api/block-index/{blockIndex}/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getTx(self, txid):
        response = await request(
            f"{self.BASE_URL}/api/tx/{txid}/", method="GET", headers=self.headers
        )
    ...
    async def getAddrHistory(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/addr/{addr}/", method="GET", headers=self.headers
        )
    ...
    async def getAddrBalance(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/addr/{addr}/balance/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getAddrReceived(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/addr/{addr}/totalReceived/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getAddrSent(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/addr/{addr}/totalSent/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getAddrUnconfirmedBalance(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/addr/{addr}/unconfirmedBalance/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getAddrUtxo(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/addr/{addr}/utxo/", method="GET", headers=self.headers
        )
    ...
    async def getMultiAddrUtxo(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/addrs/{addr}/utxo/",
            method="GET",
            headers=self.headers,
        )
        utxo = await response.json()
    ...
    async def getMultiAddrTx(self, addr, startIdx=0, endIdx=0):
        response = await request(
            f"{self.BASE_URL}/api/addrs/{addr}/txs?from={startIdx}&to={endIdx}/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getTxByBlock(self, blockHash):
        response = await request(
            f"{self.BASE_URL}/api/txs/?block={blockHash}/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getTxByAddr(self, addr):
        response = await request(
            f"{self.BASE_URL}/api/txs/?address={addr}/",
            method="GET",
            headers=self.headers,
        )
        txs = await response.json()
    ...
    async def getTxByAddrPost(self, addr, startIdx=0, endIdx=0):
        ...
        try:
            new_post = await request(
                f"{self.BASE_URL}/api/addrs/txs/",
                body=body,
                method="POST",
                headers=self.headers,
            )
    ...
    async def getVetlist(self):
        response = await request(
            f"https://explorer.myghost.org/ext/getvetlist/",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getPrice(self, currency):
        response = await request(
            f"https://api.coingecko.com/api/v3/simple/price?vs_currencies={currency}&ids=ghost-by-mcafee",
            method="GET",
            headers=self.headers,
        )
    ...
    async def getMultiAddrUtxoPost(self, addr):
        ...
        try:
            new_post = await request(
                f"{self.BASE_URL}/api/addrs/utxo/",
                body=body,
                method="POST",
                headers=self.headers,
            )
    ...
    async def getStakingInfo(self, pool, addr):
        ...
        response = await request(
            f"https://{pool}/api/address/{addr}/", method="GET", headers=self.headers
        )
        ...
        parsedHtml = {
            "Accumulated": "0.00000000",
            "" "Payout Pending": "0.00000000",
            "Paid Out": "0.00000000",
            "Last Total Staking": "0.00000000",
            "Current Total in Pool": "0.00000000",
        }
    ...
    async def getPools(self):
        response = await request(
            f"https://raw.githubusercontent.com/ghost-coin/ghost-coldstaking-pools/master/list.json",
            method="GET",
            headers=self.headers,
        )
        price = await response.json()
    ...
    async def getLang(self, lang):
        response = await request(
            f"/translations/{lang}.json", method="GET", headers=self.headers
        )
    ...
    async def pingNode(self, url):
        ...
        try:
            response = await request(
                f"{url}/ping/", method="POST", headers=self.headers
            )
        except:
            return (url, -1)
